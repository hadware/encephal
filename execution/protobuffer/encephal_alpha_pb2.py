...
_DATAENTRY_DATAENTRYTYPE = _descriptor.EnumDescriptor(
  name='DataEntryType',
  full_name='encephal_alpha.DataEntry.DataEntryType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_PIPENODE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='output_datatype', full_name='encephal_alpha.PipeNode.output_datatype', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='input_socket_index', full_name='encephal_alpha.PipeNode.input_socket_index', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='output_socket_index', full_name='encephal_alpha.PipeNode.output_socket_index', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='node_type', full_name='encephal_alpha.PipeNode.node_type', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data', full_name='encephal_alpha.PipeNode.data', index=6,
...
_GRAPH = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='node_layers', full_name='encephal_alpha.Graph.node_layers', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TRAININGDATAENTRY = _descriptor.Descriptor(
  ...
  full_name='encephal_alpha.TrainingDataEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='input_datatype', full_name='encephal_alpha.TrainingDataEntry.input_datatype', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='output_datatype', full_name='encephal_alpha.TrainingDataEntry.output_datatype', index=1,
      number=2, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='input', full_name='encephal_alpha.TrainingDataEntry.input', index=2,
      number=3, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='label', full_name='encephal_alpha.TrainingDataEntry.label', index=3,
...
_TESTINGDATAENTRY = _descriptor.Descriptor(
  ...
  full_name='encephal_alpha.TestingDataEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='input_datatype', full_name='encephal_alpha.TestingDataEntry.input_datatype', index=0,
      number=1, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='entries', full_name='encephal_alpha.TestingDataEntry.entries', index=1,
      number=2, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DATAENTRY = _descriptor.Descriptor(
  name='DataEntry',
  full_name='encephal_alpha.DataEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='encephal_alpha.DataEntry.type', index=0,
      number=1, type=14, cpp_type=8, label=2,
      has_default_value=False, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='trainDataEntry', full_name='encephal_alpha.DataEntry.trainDataEntry', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='testDataEntry', full_name='encephal_alpha.DataEntry.testDataEntry', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PIPENODE.fields_by_name['output_datatype'].message_type = _DATATYPE
...
_GRAPH.fields_by_name['node_layers'].message_type = _SCHEDULERNODELAYER
_GRAPH.fields_by_name['sockets'].message_type = _SOCKET
_TRAININGDATAENTRY.fields_by_name['input_datatype'].message_type = _DATATYPE
_TRAININGDATAENTRY.fields_by_name['output_datatype'].message_type = _DATATYPE
_TRAININGDATAENTRY.fields_by_name['input'].message_type = _DATAARRAY
_TRAININGDATAENTRY.fields_by_name['label'].message_type = _DATAARRAY
_TESTINGDATAENTRY.fields_by_name['input_datatype'].message_type = _DATATYPE
...
DESCRIPTOR.message_types_by_name['TrainingDataEntry'] = _TRAININGDATAENTRY
DESCRIPTOR.message_types_by_name['TestingDataEntry'] = _TESTINGDATAENTRY
...
PipeNode = _reflection.GeneratedProtocolMessageType('PipeNode', (_message.Message,),
    {
      ...
      'PipeNodeData': _reflection.GeneratedProtocolMessageType('PipeNodeData', (_message.Message,),
          {
...
TrainingDataEntry = _reflection.GeneratedProtocolMessageType('TrainingDataEntry', (_message.Message,),
    {
      'DESCRIPTOR': _TRAININGDATAENTRY,
      # @@protoc_insertion_point(class_scope:encephal_alpha.TrainingDataEntry)
    })

TestingDataEntry = _reflection.GeneratedProtocolMessageType('TestingDataEntry', (_message.Message,),
    {
      'DESCRIPTOR': _TESTINGDATAENTRY,
